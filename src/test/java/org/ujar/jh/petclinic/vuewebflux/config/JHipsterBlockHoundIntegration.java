...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("org.ujar.jh.petclinic.vuewebflux.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("org.ujar.jh.petclinic.vuewebflux.security.DomainUserDetailsService", "createSpringSecurityUser");
